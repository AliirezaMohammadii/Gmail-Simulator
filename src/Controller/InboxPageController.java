...
public class InboxPageController {
    ...
    public void initialize() {
        ArrayList<Conversation> reversedList = AllFirstMessageReceivedConversations.list;
...
//        return;
    ...
    public void updateList(MouseEvent mouseEvent) {
        ArrayList<Conversation> mainList = AllFirstMessageReceivedConversations.list;
        mainList.sort(comp);
    ...
    public void updateListByUnReadConversations(MouseEvent mouseEvent) {
        ArrayList<Conversation> theList = new ArrayList<>(AllFirstMessageReceivedConversations.list);
        theList.sort(comp);
